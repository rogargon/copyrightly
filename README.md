...
(available on Ethereum's testnets *Rinkeby* and *Ropsten* through https://copyrightly.rhizomik.net)

[![Build Status](https://travis-ci.org/rogargon/copyrightly.svg?branch=master)](https://travis-ci.org/rogargon/copyrightly)
...
[protractor-cucumber_report](https://rawgit.com/rogargon/copyrightly/master/e2e/protractor-cucumber_report.html)
...
To install the project and all the required tools:
 ...
 (or [download](https://github.com/rogargon/copyrightly/archive/master.zip) and unzip):
 
```
git clone https://github.com/rogargon/copyrightly.git
```

 2.- Install the project dependencies and development tools, using the following commands from the "copyrightly" folder
...
[ethpm.json](https://github.com/rogargon/copyrightly/blob/ConsensysAcademy2018/ethpm.json). 
...
after deactivating it, CopyrightLY will offer the option to login using uPort. 
...
The result is [Complaints.vy](https://github.com/rogargon/copyrightly/blob/ConsensysAcademy2018/contracts/Complaints.v.py), 
...
branch corresponding to the [Consensys Academy 2018 submission](https://github.com/rogargon/copyrightly/tree/ConsensysAcademy2018/)
...
Ropsten is the network intended when using the client Web application deployed at: https://copyrightly.rhizomik.net
